...
export const services: Service[] = [
  {
    ...
    iconName: 'search',
    title: 'SEO/GEO',
    tagline: 'Audits techniques, pSEO, visibilité IA',
    description:
      "SEO classique (Google) et GEO (Generative Engine Optimization) pour ChatGPT, Perplexity, AI Overviews et Bing Copilot. Audits, clustering SERP, contenu on-page, pSEO à grande échelle et citabilité IA.",
    longDescription:
      "Le référencement ne se limite plus à Google. En 2026, une part croissante du trafic de marque passe par les moteurs IA : ChatGPT, Perplexity, Google AI Overviews, Bing Copilot. Je couvre les deux fronts. Côté SEO classique, je pars toujours d'un audit technique complet (Core Web Vitals, indexation GSC, rendu JavaScript, maillage interne) avant de parler contenu, puis je définis l'architecture sémantique via un clustering SERP-based. Côté GEO, j'optimise la citabilité : passages courts auto-suffisants, FAQ structurées, Schema.org cohérent, llms.txt, accessibilité aux crawlers IA. Expérience concrète en alternance chez Primelis et sur plusieurs sites personnels où je pousse pSEO + automatisation LLM.",
    bullets: [
      "Audits SEO techniques (GSC, Core Web Vitals, indexation, rendu JS)",
      "GEO : audit de citabilité IA (ChatGPT, Perplexity, AI Overviews, Copilot)",
      "Clustering sémantique SERP-based et recherche de mots-clés",
      "pSEO : pages à grande échelle via templates + sources de données",
      "Optimisation on-page (titles, meta, schema JSON-LD, maillage, llms.txt)",
      "Reporting mensuel GSC + GA4 avec actions prioritaires",
    ],
    tools: ['Semrush', 'Ahrefs', 'Screaming Frog', 'GSC', 'GA4', 'Sistrix'],
    cta: { label: 'Voir les case studies SEO/GEO', href: '/case-studies' },
  },
  {
    slug: 'automation',
    icon: Workflow,
  ...
  },
  {
    ...
    longDescription:
      "Le bon stack pour le bon projet. Astro ou Next.js pour les sites statiques ultra-rapides (Lighthouse 100), WordPress quand l'éditorial doit rester accessible à une équipe non-tech, templates MFA pour l'affiliation Amazon à grande échelle. Côté infra, je déploie sur VPS Docker avec Traefik et Let's Encrypt : plus contrôlable et souvent plus économique qu'une plateforme managée. Je gère aussi la partie invisible : CI/CD GitHub Actions, backups, monitoring, et les petits scripts qui font la différence entre un site qu'on maintient et un site qu'on subit.",
    bullets: [
