...
import Skills3D from './common/Skills3D';
    ...
    <section id="skills" className="relative py-24 bg-slate-950 overflow-hidden">
      ...
      <div className="container relative z-10 mx-auto px-6">
          ...
          >
            <div className="inline-flex p-1.5 rounded-2xl bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm border border-gray-200 dark:border-gray-700 shadow-xl">
              <button
                ...
                className={`flex items-center gap-2 px-8 py-4 rounded-xl font-semibold transition-all duration-300 ${activeTab === 'technical'
              ...
              <button
                ...
                className={`flex items-center gap-2 px-8 py-4 rounded-xl font-semibold transition-all duration-300 ${activeTab === 'soft'
                  ? 'bg-gradient-to-r from-primary-600 to-blue-600 text-white shadow-lg scale-105'
                  : 'text-gray-600 dark:text-gray-300 hover:text-primary-600 dark:hover:text-primary-400 hover:bg-gray-100 dark:hover:bg-gray-700/50'
                  }`}
              >
        ...
        <div className="max-w-6xl mx-auto min-h-[600px]">
          {activeTab === 'technical' ? (
            <React.Suspense fallback={<div className="text-white text-center">Chargement de la matrice 3D...</div>}>
              <Skills3D />
            </React.Suspense>
          ) : (
